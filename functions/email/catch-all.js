// Email Worker for Cloudflare Pages Functions — handles Email Routing
...
// Email Routing handler (required for Pages Functions email worker)
...
export async function onRequest(context) {
  return new Response('Email worker ready', { status: 200 });
}